...
Usage:
    python scripts/poisson_glm_refactored/fit_neuron_cv.py --neuron_id 42 --model_file 1stim_1coh_2choice_1500ms
    python scripts/poisson_glm_refactored/fit_neuron_cv.py --neuron_id 42 --model_file 7stim_7coh_2choice_1500ms --prior_cond equal_block --outcome_filter correct_only

Available model files (scripts/poisson_glm_refactored/models/):
