...
from .likelihood_calculator_new import LikelihoodCalculator
...
class DecisionModel:
    ...
    def __init__(
        ...
        self.likelihood_calc = LikelihoodCalculator(
            moment_weight=lp.get("moment_weight", 1.0),
            eps=lp.get("eps", 1e-12),
            entropy_floor=lp.get("entropy_floor", 0.2),
        )
        logger.info(
